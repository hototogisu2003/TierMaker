...
export const FRUIT_OPTIONS: FruitOption[] = [
  ...
  { id: 15, name: "撃種加速命", isStatus: true, bonuses: { L: { hp: 1000, attack: 0, speed: 13.2 }, EL: { hp: 1100, attack: 0, speed: 14.5 } } },
  ...
  { id: 18, name: "戦型加速命", isStatus: true, bonuses: { L: { hp: 1000, attack: 0, speed: 13.2 }, EL: { hp: 1100, attack: 0, speed: 14.5 } } },
